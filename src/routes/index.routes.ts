...
import {
  assignedOrderSchemaPatch,
  assignedOrderSchema,
} from "../models/assigned_order.models";
...
router.patch(
  "/patchCompany/:id",
  validator.body(companySchemaPatch),
  patchCompany
);
...
router.post(
  "/postAssignedOrder",
  validator.body(assignedOrderSchema),
  postAssignedOrder
);
router.put(
  "/putAssignedOrder/:id",
...
router.patch(
  ...
  validator.body(assignedOrderSchemaPatch),
  patchAssignedOrder
);
